...
const S=8,done=new Set();let player={x:39,y:70},active=null,movingUntil=0;
const rooms=[
...
document.querySelector('#close-game').onclick=()=>dialog.close();game.addEventListener('click',()=>game.focus());game.focus();update();requestAnimationFrame(animateRepairFrames);
